 ...
 * @TODO: when a msg is pushed back to the queue, the script tries to process it immediately again!  keep track of transactions already checked
 */
...
class StompPFPPendingProcessorSA {
	...
	protected function log( $message, $level=LOG_LEVEL_INFO ) {
		if ( $this->log_level >= $level ) $out = date('c') . ": " . $level . " : " .  $message . "\n";
